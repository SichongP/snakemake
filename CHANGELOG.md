...
## [8.4.1](https://github.com/SichongP/snakemake/compare/v8.5.2...v8.4.1) (2024-02-24)


### ⚠ BREAKING CHANGES

* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/SichongP/snakemake/issues/2403))
...
* add --sdm short opt for --deployment ([#2551](https://github.com/SichongP/snakemake/issues/2551)) ([fd8b4b0](https://github.com/SichongP/snakemake/commit/fd8b4b08da778097071ea8c32c95e21e610c6614))
* add ability to inject conda environments into running Snakefile ([#2479](https://github.com/SichongP/snakemake/issues/2479)) ([6140e29](https://github.com/SichongP/snakemake/commit/6140e29864cf0fcdd83194f218408867c54b730d))
* add ability to return input functions from input functions. Such nesting is evaluated 10 times at most. Beyond that, an error is thrown.  ([#2717](https://github.com/SichongP/snakemake/issues/2717)) ([7a47924](https://github.com/SichongP/snakemake/commit/7a47924627b30dc774efef0faae08e13e44c350a))
...
* add cols argument to lookup function; fix various minor bugs on cluster systems ([#2651](https://github.com/SichongP/snakemake/issues/2651)) ([ca7a602](https://github.com/SichongP/snakemake/commit/ca7a6022bacae77be45068adbf4386c2c93fb481))
* add functionality for deploying sources if no shared FS is assumed ([#2486](https://github.com/SichongP/snakemake/issues/2486)) ([76eac3c](https://github.com/SichongP/snakemake/commit/76eac3c570624f818ff43f4759a27a3e284bf03c))
* add method to obtain group args for spawned jobs ([bd1b450](https://github.com/SichongP/snakemake/commit/bd1b450950c5b6e510778ca09fe11beffd9a6ff3))
* add option to control software deployment mode (shared or non shared FS) ([#2525](https://github.com/SichongP/snakemake/issues/2525)) ([04ec2c0](https://github.com/SichongP/snakemake/commit/04ec2c0262b2cb96cbcd7edbbb2596979c1703ae))
...
* allow detailed configuration of shared FS usage ([#2528](https://github.com/SichongP/snakemake/issues/2528)) ([0d34be9](https://github.com/SichongP/snakemake/commit/0d34be90040f937021eb25becb4ef5d5aae66473))
* allow environment variables in string values of profile (e.g. paths may now contain elements like $USER). ([58dc70c](https://github.com/SichongP/snakemake/commit/58dc70c513d08cb217647ec591df93b40517b650))
...
* allow profiles to be YTE templates; adapt to eido 2.0 ([#2325](https://github.com/SichongP/snakemake/issues/2325)) ([67d9ff2](https://github.com/SichongP/snakemake/commit/67d9ff20ea61186d3818e7bc1d33e4414058fc1f))
* allow python expressions in --set-resources ([#2521](https://github.com/SichongP/snakemake/issues/2521)) ([022a31e](https://github.com/SichongP/snakemake/commit/022a31e0e75416904589c62b58e54c952d930c69))
...
* allow to set latency_wait in executor test suite ([c0bca0b](https://github.com/SichongP/snakemake/commit/c0bca0bb8bf66fb34def7459f757140ce3825a25))
* automatically upload workflow sources to default storage provider if no shared FS is used ([a450c49](https://github.com/SichongP/snakemake/commit/a450c4998de3ab7deb0fb2bc19dc59fdc484309d))
...
* Faster ci test setup  ([#2489](https://github.com/SichongP/snakemake/issues/2489)) ([4798e8a](https://github.com/SichongP/snakemake/commit/4798e8ac226bded585e9fe31d43ae9e93a598780))
...
* implement precommand ([#2482](https://github.com/SichongP/snakemake/issues/2482)) ([ff0f979](https://github.com/SichongP/snakemake/commit/ff0f979b68b1e12be8151c7f5547c6a13ad3ee9a))
* implement semantic helper functions for input and param function handling ([#2344](https://github.com/SichongP/snakemake/issues/2344)) ([b4b5e51](https://github.com/SichongP/snakemake/commit/b4b5e51ee8601b81a7ac900b2d175603c5af90a9))
...
* prepare for storage plugins ([#2454](https://github.com/SichongP/snakemake/issues/2454)) ([353a71c](https://github.com/SichongP/snakemake/commit/353a71cba1d3dfcc48136b2d6cb744cc1252623b))
* provide information about temp, pipe, and service files in --summary ([#1977](https://github.com/SichongP/snakemake/issues/1977)) ([c7c7776](https://github.com/SichongP/snakemake/commit/c7c7776f8722adf94e6a176174cb0a7564f11d9f))
...
* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/SichongP/snakemake/issues/2403)) ([2be3bfa](https://github.com/SichongP/snakemake/commit/2be3bfa4841967928069a2a024554b8a86b699f1))
...
* support for continuously updated input (using Python queues) ([#2594](https://github.com/SichongP/snakemake/issues/2594)) ([db1c0ed](https://github.com/SichongP/snakemake/commit/db1c0edcadca499d51223d5cc72cbdfca1ff5d21))
...
* support for report plugins ([#2700](https://github.com/SichongP/snakemake/issues/2700)) ([2f7d4b5](https://github.com/SichongP/snakemake/commit/2f7d4b5196979d368f6e2eede25ca2a61220691b))
...
* version specific profile config files (profile/config.v8+.yaml with profile/config.yaml as fallback that matches any version) ([#2498](https://github.com/SichongP/snakemake/issues/2498)) ([47e5811](https://github.com/SichongP/snakemake/commit/47e581181f952884577f0237a1aa9457ee9554dd))
...
* adapt to changes in snakemake-interface-executor-plugins ([635c68a](https://github.com/SichongP/snakemake/commit/635c68abe3c6e01a70803f2423718a99ea056a00))
* add mamba to docker image ([eb0c884](https://github.com/SichongP/snakemake/commit/eb0c88495b506300fdf7c1afc4c02d6b91c6a582))
...
* add storage provider args to deploy sources command ([67178e3](https://github.com/SichongP/snakemake/commit/67178e31e68dc165c503d49eaf40340a9ad65e90))
* add testcase for script directive to work with Python 3.7 and corresponding fix. ([0b4ae2e](https://github.com/SichongP/snakemake/commit/0b4ae2e1155378a78e0786ad4dfd5d44fa41c9ae))
* addressing [#2197](https://github.com/SichongP/snakemake/issues/2197) by allowing 256 character account names in slurm ([#2198](https://github.com/SichongP/snakemake/issues/2198)) ([ab58c65](https://github.com/SichongP/snakemake/commit/ab58c652847c03a9f1529d2d7632f2788a5fadc4))
* allow lookup dpath or query to be a callable ([33f1637](https://github.com/SichongP/snakemake/commit/33f16379a5fb7f210769b888ab34fe8a8df96daf))
* allow pepfile and pepschema to take pathlib ([#2546](https://github.com/SichongP/snakemake/issues/2546)) ([ca91661](https://github.com/SichongP/snakemake/commit/ca91661bf2ff215f005e8d9351fa3320d5cf5498))
* also inherit rule proxies if there is no rulename modifier specified in a use rule statement ([#2440](https://github.com/SichongP/snakemake/issues/2440)) ([1570289](https://github.com/SichongP/snakemake/commit/15702891b31635a79f31e857d09f3e285f71717b))
...
* assume at most 8GB memory for default resources. This way, we avoid exploding memory requirements for large input files that are very unlikely to be put entirely into memory by any tool. ([11c2ecc](https://github.com/SichongP/snakemake/commit/11c2eccfa72a2732d20a66bbf57995ee9dfd14ae))
...
* batch bug [#2643](https://github.com/SichongP/snakemake/issues/2643) ([#2650](https://github.com/SichongP/snakemake/issues/2650)) ([2ecb21b](https://github.com/SichongP/snakemake/commit/2ecb21ba04088b9e6850447760f713784cf8b775))
...
* binary mem ([#2695](https://github.com/SichongP/snakemake/issues/2695)) ([18689b4](https://github.com/SichongP/snakemake/commit/18689b42dcc690deea7f27dc909379f603aaa1a9))
* bug with preemptible rules ([#2616](https://github.com/SichongP/snakemake/issues/2616)) ([c6d7141](https://github.com/SichongP/snakemake/commit/c6d71410a042f2c0075a75fc024bd1e05fe0af15))
...
* comparison to float in scheduler ([ef44d84](https://github.com/SichongP/snakemake/commit/ef44d844b81d671604a1ce285a43ca1d5ea59d96))
...
* constrain dependencies to match conda experience ([#2710](https://github.com/SichongP/snakemake/issues/2710)) ([d9a7a13](https://github.com/SichongP/snakemake/commit/d9a7a13d6e427c025902a78c2d21c3f21cac242b))
...
* correctly report lineno ([#2584](https://github.com/SichongP/snakemake/issues/2584)) ([967a0d7](https://github.com/SichongP/snakemake/commit/967a0d7cb90c63c7be00b49fd535cf1029f63b5b))
* deduplicate input files before retrieval from storage ([#2600](https://github.com/SichongP/snakemake/issues/2600)) ([37cf475](https://github.com/SichongP/snakemake/commit/37cf475a4205d306a3969ab0e3249f0c9f7d4e19))
* detect job paths that leave and then enter a group. Such paths are invalid because then the group depends on itself. ([#2527](https://github.com/SichongP/snakemake/issues/2527)) ([5383a4d](https://github.com/SichongP/snakemake/commit/5383a4d85f8b7a3fb61fd0b457fcd1d008c2255f))
...
* do not pass snakefile as metadata when wms monitor flag is used ([#2573](https://github.com/SichongP/snakemake/issues/2573)) ([13b3205](https://github.com/SichongP/snakemake/commit/13b3205a6e808dc48fd7a3be9652b9f0c8887648))
* do not require cores to be set for non-executing modes ([#2646](https://github.com/SichongP/snakemake/issues/2646)) ([30cf026](https://github.com/SichongP/snakemake/commit/30cf0261004be7a4bdce5ade563271e52c97ad6a))
* do not require cores to be set for rule-level methods of the workflow API or the corresponding CLI commands (e.g. --lint). ([#2629](https://github.com/SichongP/snakemake/issues/2629)) ([2040468](https://github.com/SichongP/snakemake/commit/20404688e91beadd8790e3c6cdcb727bc47d597e))
* Do not scheduler execution message if no jobs are ready ([b1c4f47](https://github.com/SichongP/snakemake/commit/b1c4f47f894e344bd48b615f397c9ab03dc05f73))
* Don't attempt to parse TBDString resources ([#2690](https://github.com/SichongP/snakemake/issues/2690)) ([f884b50](https://github.com/SichongP/snakemake/commit/f884b50eddf30f829b0f7d2bbda77d0148cf8cd7))
...
* ensure that auto deployment of default storage provider works in containers with read-only root home. ([1a347ff](https://github.com/SichongP/snakemake/commit/1a347ffd8b2144aee5c35ea17fec2262c5cc9c40))
* ensure that log and benchmark files are uploaded to storage as well ([#2545](https://github.com/SichongP/snakemake/issues/2545)) ([6aabb5d](https://github.com/SichongP/snakemake/commit/6aabb5db16634c077ba808dbd000a3ed67d6a3c0))
* ensure that targetjob is always forced. This fixes a bug causing run-directive rules to not being executed even when enforced via e.g. -R. ([#2448](https://github.com/SichongP/snakemake/issues/2448)) ([b2a60d5](https://github.com/SichongP/snakemake/commit/b2a60d5674c84f58c6e48af5d675ce4690a1d625))
...
* f-string in a more robust style? ([#2649](https://github.com/SichongP/snakemake/issues/2649)) ([2a50dc0](https://github.com/SichongP/snakemake/commit/2a50dc02bb709161d62d6f7dc5d6f2733e534c09))
* fix bug causing FileNotFoundError when accessing checkpoint output. ([c81954d](https://github.com/SichongP/snakemake/commit/c81954d0bc10011a777aef7d0d5f089ee5748342))
* fix cache handling and unlock handling ([2f4d5e1](https://github.com/SichongP/snakemake/commit/2f4d5e11b36f199d3335839e9b5dc5d2094d11f8))
* Fix collect-lookup attribute error ([#2687](https://github.com/SichongP/snakemake/issues/2687)) ([e39c74c](https://github.com/SichongP/snakemake/commit/e39c74c18d59f117f1e630a516ba00ee8a53c9e8))
* fix error when passing callable as dpath or query of lookup function ([0e5b878](https://github.com/SichongP/snakemake/commit/0e5b8789c763201d00e5040f439436405d04b706))
* fix exception when handling syntax error during parsing ([d5a7a56](https://github.com/SichongP/snakemake/commit/d5a7a564beea9850d1dac9f91429d8434a3aac46))
* fix false complaints about rules with multiple output files ([#2628](https://github.com/SichongP/snakemake/issues/2628)) ([b1b4f5b](https://github.com/SichongP/snakemake/commit/b1b4f5b0adcd8066b7a6376e9b56778014f9921b))
...
* fix missing storage information when handling already completed checkpoints. This solves a bug causing failure to retrieve storage files in workflows with checkpoints. ([5791c60](https://github.com/SichongP/snakemake/commit/5791c6017195dd00a5d98c1da1e81fbfdde253b9))
* fix nargs definition for --deploy-sources ([fc252c8](https://github.com/SichongP/snakemake/commit/fc252c80227e75a4fcf869f828d3c7d5d066f794))
...
* fix path handling when detective profiles ([fe63881](https://github.com/SichongP/snakemake/commit/fe63881371036fc6d55e6a113cb3ed5029b31d2d))
...
* fix storage handling on windows by converting all paths to posix paths ([#2519](https://github.com/SichongP/snakemake/issues/2519)) ([7864a76](https://github.com/SichongP/snakemake/commit/7864a76c41ad7839fb3b9aeb1c4468215ba0cb21))
* fix string resource definition in CLI and profile ([#2627](https://github.com/SichongP/snakemake/issues/2627)) ([bbd76ae](https://github.com/SichongP/snakemake/commit/bbd76ae53101a28f86386d12b3bdb10a89df2251))
* fix wait for files in case of using remote storage and remote execution ([#2718](https://github.com/SichongP/snakemake/issues/2718)) ([eec3a5f](https://github.com/SichongP/snakemake/commit/eec3a5fd7a02c093dc14cfd0912fbaf8d7dd10cc))
* fixed bug in handling of resource overrides for remote job submission ([5c06dd6](https://github.com/SichongP/snakemake/commit/5c06dd6a3273057144a8d5e1305c7cbdfc329b66))
* Fixed plot axis label on report ([#2683](https://github.com/SichongP/snakemake/issues/2683)) ([a4c2a03](https://github.com/SichongP/snakemake/commit/a4c2a03182d5f1bd5e7a9e389dc816cf7a9bc124))
...
* for local execution, always unrestrictedly assume shared FS ([#2679](https://github.com/SichongP/snakemake/issues/2679)) ([0bee50b](https://github.com/SichongP/snakemake/commit/0bee50b24538e9e17f8679fe4e7022f335e32d72))
...
* handle different f-string tokens in py3.12 ([#2485](https://github.com/SichongP/snakemake/issues/2485)) ([f2c7613](https://github.com/SichongP/snakemake/commit/f2c761320a5a73d6027ae3649843e6bf6a24f324))
...
* handle storage for local jobs; add test case ([6d978ef](https://github.com/SichongP/snakemake/commit/6d978ef31060393bd3a69b7973170e3c79473705))
* handling of group jobs when obtaining temp input files ([71be1de](https://github.com/SichongP/snakemake/commit/71be1de734032ae8c9e8b07fad57e36b321be421))
* if report files are within storage, retrieve them from storage before loading into report ([60041bd](https://github.com/SichongP/snakemake/commit/60041bdbc3c6e941585f1876f3e5d598bfaa9caf))
...
* improved error handling for storage upload; fixed bugs caused by outdated calls to IOFile.exists(). ([720bb84](https://github.com/SichongP/snakemake/commit/720bb8400ecf8e6c3caf3ca6b47d7dda4f1f7ba9))
* improved error messages in case of invalid storage queries ([9671fd0](https://github.com/SichongP/snakemake/commit/9671fd0770fbe2d79d3546ca5f19c8fc39ffc25a))
* in addition to localrules statement,  infer that job is local if it has any input or output file that is marked as local ([#2541](https://github.com/SichongP/snakemake/issues/2541)) ([e8b682b](https://github.com/SichongP/snakemake/commit/e8b682be0bd52a01ec3ebdbbcb1ec018950819b2))
* is_run error with local, group jobs ([#2133](https://github.com/SichongP/snakemake/issues/2133)) ([31bfcd5](https://github.com/SichongP/snakemake/commit/31bfcd5399540fc6cf52e3b76144e9abea6d4eab))
...
* local mtime handling in case of storage plugins and cleaner error message for parallel storage retrieval ([#2611](https://github.com/SichongP/snakemake/issues/2611)) ([880b264](https://github.com/SichongP/snakemake/commit/880b2645c961a98c0eb33b9cdab75d7804860c0a))
...
* Migrate away from deprecated pulp API ([#2610](https://github.com/SichongP/snakemake/issues/2610)) ([fb26640](https://github.com/SichongP/snakemake/commit/fb2664008d6cffd09c52ec9fd9c994bd198ed69c))
* migration guide typo and wrong link ([#2625](https://github.com/SichongP/snakemake/issues/2625)) ([645f3d1](https://github.com/SichongP/snakemake/commit/645f3d1426c1dcd41adf813bdb833060775ffda5))
...
* move apptainer into separate env in docker image ([94e9e2c](https://github.com/SichongP/snakemake/commit/94e9e2c33ee63551aa3630c7106344ee2fa11f4d))
...
* only deactivate conda inject envs upon workflow tear down ([#2503](https://github.com/SichongP/snakemake/issues/2503)) ([e6dfdd4](https://github.com/SichongP/snakemake/commit/e6dfdd49cbaad228827f62a48cfe6419e4c1715e))
* output of rulegraph, closes [#2656](https://github.com/SichongP/snakemake/issues/2656) ([#2671](https://github.com/SichongP/snakemake/issues/2671)) ([f9b9110](https://github.com/SichongP/snakemake/commit/f9b9110b2b0e25db25f76ceeabcf548b70aff839))
* Panoptes --wms-monitor-arg ([#2444](https://github.com/SichongP/snakemake/issues/2444)) ([98d2bdf](https://github.com/SichongP/snakemake/commit/98d2bdfd1e3aeddf189b272d3e4042632248c10f))
...
* proper interpretation of standard resources given as strings (e.g. runtime as '5m'). Avoid the need to set additional quotes around size or timespan resources. Improved error messages for resource handling.  ([#2716](https://github.com/SichongP/snakemake/issues/2716)) ([b6636e9](https://github.com/SichongP/snakemake/commit/b6636e95f6d9baddb4a3eb5bc79351207f048b4d))
...
* properly handle --touch when using a storage provider ([#2705](https://github.com/SichongP/snakemake/issues/2705)) ([fca138d](https://github.com/SichongP/snakemake/commit/fca138d680ac0abad14df8dc208a84f1ae0dc0e2))
...
* properly resolve wildcards in group components ([#2620](https://github.com/SichongP/snakemake/issues/2620)) ([c788a46](https://github.com/SichongP/snakemake/commit/c788a465f25dc700103df6475d566d81e2c88bef))
...
* remove bash completion entrypoint (no longer supported, was too slow to be usable anyway) ([922b53a](https://github.com/SichongP/snakemake/commit/922b53aa0cba05da067cc67fccc6852bbc161edb))
...
* removed distutils from snakemake ([#2312](https://github.com/SichongP/snakemake/issues/2312)) ([9b8c362](https://github.com/SichongP/snakemake/commit/9b8c3620e8c14e322ba15b7d044b9deab1854b2a))
...
* Restore backward compatibility for Google Life Sciences executor ([#2461](https://github.com/SichongP/snakemake/issues/2461)) ([5e3a464](https://github.com/SichongP/snakemake/commit/5e3a46476d78d5d52340a9ffa327d18a5e7e9828))
* return set of rules when obtaining allowed rules for remote job ([2c44cf6](https://github.com/SichongP/snakemake/commit/2c44cf641335812ca0877e3987726403c8919415))
...
* set ignore_incomplete to False in create_conda_envs  ([#2653](https://github.com/SichongP/snakemake/issues/2653)) ([4834a42](https://github.com/SichongP/snakemake/commit/4834a42180fb513670b310fcbaadd07a34adf0b7))
* Setting the value of ignore_incomplete Fixes [#2556](https://github.com/SichongP/snakemake/issues/2556) ([#2654](https://github.com/SichongP/snakemake/issues/2654)) ([05dac64](https://github.com/SichongP/snakemake/commit/05dac64666cca196e232beed4b6f1167dfbfc3bd))
* shadow "full" mode ignore symlinks ([#2516](https://github.com/SichongP/snakemake/issues/2516)) ([1d58120](https://github.com/SichongP/snakemake/commit/1d5812027e5d1a8d5f2e45175fa38d28ca32763e))
* show failed logs in executor testcases ([92f7bf4](https://github.com/SichongP/snakemake/commit/92f7bf4b86f491073898b2385c3ed45a557a3b4d))
...
* single line f-string format error in py3.12 ([#2588](https://github.com/SichongP/snakemake/issues/2588)) ([87c06c0](https://github.com/SichongP/snakemake/commit/87c06c0f5745f577c12db39852c6f763a2d41954))
...
* Slack log service ([#2537](https://github.com/SichongP/snakemake/issues/2537)) ([26eb4ba](https://github.com/SichongP/snakemake/commit/26eb4babc28464a24c33d75703e7bf4f15c0e33f))
...
* sort report (sub-)categories in lexicographical order ([#2449](https://github.com/SichongP/snakemake/issues/2449)) ([d0705ad](https://github.com/SichongP/snakemake/commit/d0705adb4702ead9db0c26809859c7b769d800e1))
* support list of queries for storage provider ([#2674](https://github.com/SichongP/snakemake/issues/2674)) ([d53ef92](https://github.com/SichongP/snakemake/commit/d53ef92e79f5e8cf0187a1aa25c321c1478914d8))
* SyntaxWarning due to invalid escape sequences in non-raw regex pattern string ([#2670](https://github.com/SichongP/snakemake/issues/2670)) ([3748d9d](https://github.com/SichongP/snakemake/commit/3748d9dc937195a54bc052994f6d2fa05373da42))
...
* update minimum snakemake-interface-storage-plugins version ([0ef7226](https://github.com/SichongP/snakemake/commit/0ef72262e29a5b22cdf016a4ab6aba4b8dbc686d))
...
* use default container image if nothing is provided ([#2677](https://github.com/SichongP/snakemake/issues/2677)) ([109c991](https://github.com/SichongP/snakemake/commit/109c991cea1ca757086488b3ca07f59cb843b46f))
* use default group settings if not execution workflow (fixes attribute error occurring with --report) ([#2617](https://github.com/SichongP/snakemake/issues/2617)) ([21e9964](https://github.com/SichongP/snakemake/commit/21e996421abd72122a1403a10eb74c111bde28be))
...
* use temporary directory (faster, more likely local, always writable) for persistence and source cache in case of remote execution without shared fs ([#2502](https://github.com/SichongP/snakemake/issues/2502)) ([c8fa7ba](https://github.com/SichongP/snakemake/commit/c8fa7ba3ee70c9c62011a3839758a5eb8fde16f8))
...
* various bug fixes for resource parsing ([#2711](https://github.com/SichongP/snakemake/issues/2711)) ([d1daf0b](https://github.com/SichongP/snakemake/commit/d1daf0b4b2cc64b92adb9f58ac71c601ab5d29c8))
* wait for logs before showing them on error ([a4ff328](https://github.com/SichongP/snakemake/commit/a4ff3280db0beb4f1a077ee880433f767c4ad142))
* when using remote storage: only wait for files if job did not error ([8c7ee91](https://github.com/SichongP/snakemake/commit/8c7ee91ac5425279955e60071fd0269bf2bf197b))
...
* add missing doc dependency ([7ba9c21](https://github.com/SichongP/snakemake/commit/7ba9c21ac949ae6952044944af68874c516791ff))
* add note on google executor backends ([ff8683c](https://github.com/SichongP/snakemake/commit/ff8683c80511a78103c14442a3d3fb81bcbef2cc))
...
* added Mastodon follow label with just 'Follow' similar to X ([#2692](https://github.com/SichongP/snakemake/issues/2692)) ([7e36496](https://github.com/SichongP/snakemake/commit/7e364968fb601b2fd87dc5cd703e251b708a0e19))
* api docs polishing ([58a6a13](https://github.com/SichongP/snakemake/commit/58a6a139a6fe2719de7d2d7c98e21f4d33a67cba))
...
* diff 7 and 8 ([#2561](https://github.com/SichongP/snakemake/issues/2561)) ([ba22e07](https://github.com/SichongP/snakemake/commit/ba22e07af2ab8248888cb57f4bcb8a9eb2623977))
* document name directive with example ([#2534](https://github.com/SichongP/snakemake/issues/2534)) ([cce5551](https://github.com/SichongP/snakemake/commit/cce555142814f5bd1d73e68b9a17b772454817d4))
* fix [#2698](https://github.com/SichongP/snakemake/issues/2698) ([#2714](https://github.com/SichongP/snakemake/issues/2714)) ([508080b](https://github.com/SichongP/snakemake/commit/508080b8e1185c45e4c3d7b413350c68444db90c))
...
* fix apidocs theme ([1fb5467](https://github.com/SichongP/snakemake/commit/1fb546772bc90d96af2a390ced2d02db100ad810))
* fix cli options rendering ([264c1a9](https://github.com/SichongP/snakemake/commit/264c1a92e824323b3060192d7a22aeb0c07678e0))
* fix formatting ([087fe63](https://github.com/SichongP/snakemake/commit/087fe6307a72a577daefcea0cb150f69092138c7))
* fix heading ([1eda36d](https://github.com/SichongP/snakemake/commit/1eda36d9d7e545b05428548f8b826e941ad078d9))
* fix headings ([d947f85](https://github.com/SichongP/snakemake/commit/d947f85172f777ade0dc97bbe853c456517f28f6))
...
* fix syntax in cluster example ([#2460](https://github.com/SichongP/snakemake/issues/2460)) ([64e9645](https://github.com/SichongP/snakemake/commit/64e964554748bdee93bad1c7e6cd2924595c414f))
...
* fix typo in `rules.py` ([#2636](https://github.com/SichongP/snakemake/issues/2636)) ([8bc2919](https://github.com/SichongP/snakemake/commit/8bc291933201e205717f3346b743153b57764a6a))
...
* fixes in migration guide ([f8adefa](https://github.com/SichongP/snakemake/commit/f8adefaa605bd87df40440a211276a6825d138ed))
* format table ([4180a1b](https://github.com/SichongP/snakemake/commit/4180a1b6a8b7104e27a748c638275b98c5998200))
* handle overflow of content div ([b23e277](https://github.com/SichongP/snakemake/commit/b23e2776ce810d64225e7675039a33ac0e920bb9))
* improve branch function docs ([e9d1a11](https://github.com/SichongP/snakemake/commit/e9d1a11ca67456d7304b580ae6e1f1ae01e712cd))
...
* notes on arm based machines in tutorial docs ([0586f04](https://github.com/SichongP/snakemake/commit/0586f04d2b03443a25deddd017f303156acdcd9c))
...
* **rust:** Fix typo on rust-script version ([#2488](https://github.com/SichongP/snakemake/issues/2488)) ([a79dd94](https://github.com/SichongP/snakemake/commit/a79dd94f330f1d5c1fba7d16cb5b08bd780d950d))
...
* use sphinxawesome-theme instead of lutra ([4401e9c](https://github.com/SichongP/snakemake/commit/4401e9c2c53adb46609930b872b5da27b5af58fe))


### Miscellaneous Chores

* release 8.4.1 ([f8b3bd7](https://github.com/SichongP/snakemake/commit/f8b3bd785e0751e7153346d9fed563f5e4acf6d8))
